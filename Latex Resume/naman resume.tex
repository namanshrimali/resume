...
\resumeHeadingListStart{}
  ...
  \workex{Software Development Engineer, Amazon Web Services, Seattle, WA}{Feb 2023 -- Present}
  {Worked as backend engineer for Amazon Kinesis Data Streams, a serverless and scalable streaming data service }
    \resumeItemListStart{}
      \resumeItem{Generated \textbf{80\% of region's traffic} by creating a distributed load generation module with \textbf{AWS EC2, SQS, S3} using multiple hosts.}
    ...
    {\textit{Credible’s online marketplace offers consumers to compare and refinance loans, mortgages, and other financial products from lenders.}}
      \resumeItemListStart{}
        \resumeItem{Reduced lender onboarding time to \textbf{7 days} by streamlining codebase with \textbf{design patterns} and simple yaml configurations.}
  ...
  {Created "Schedule and Save" feature for Albertsons (US) and worked for "Cards and Payments" feature for Westpac (AU)}
    \resumeItemListStart{}
      \resumeItem{Built reusable components on \textbf{Angular} and \textbf{RESTful Microservices} on \textbf{Spring Reactive} for asynchronous order transactions}
...
\section{Personal Projects}
  \resumeHeadingListStart{}
    \resumeTrioHeading{\href{https://spryly.namanshrimali.com}{\uline{Spryly}}}{}{Jun 2021 -- Jul 2021}
      ...
      \resumeTrioHeading{\uline{Timebox}}{}{Apr 2023 -- Present}
      \resumeItemListStart{}
